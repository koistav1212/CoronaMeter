...
public class VideoPlayerRecyclerView extends RecyclerView {
    ...
    public void playVideo(boolean isEndOfList) {
        ...
        com.example.exorecycle.VideoPlayerViewHolder holder = (com.example.exorecycle.VideoPlayerViewHolder) child.getTag();
        if (holder == null) {
            playPosition = -1;
            return;
        }
        ...
        mediaUrl = mediaObjects.get(targetPosition).getMedia_url();
        if (mediaUrl != null) {
    ...
    private OnClickListener videoViewClickListener = new OnClickListener() {
        ...
        public void onClick(View v) {
            Intent sharingIntent = new Intent(context.getApplicationContext(),PlayerActivity.class);

            sharingIntent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
            sharingIntent.putExtra("position",targetPosition);
            sharingIntent.putExtra("mediaobject", mediaObjects);
